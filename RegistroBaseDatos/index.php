...
<html lang="es">
  <head>
  <title>Registro ALKAMEDICA</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    ...
    <style type="text/css">
    .backgroundFondo{
    background: url(./assets/./images/alkamedica.jpg) no-repeat center top;
...
<div class="world-latest-articles">
    ...
    <div class="form">
        <div id="signup">
            <h1 class="text-center" style="color: #fff; font-family: 'Poppins', sans-serif;">Iniciar Sesión</h1>
